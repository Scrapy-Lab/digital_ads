...
@section('content')
    ...
    style="background-image: url('{{ $data['banner_image'] }}');">
    <button
        class="text-white min-[2550px]:text-[2vw] min-[2550px]:translate-x-[22%] min-[2550px]:translate-y-48 max-[599px]:text-[3vw] translate-x-[10%] max-[599px]:translate-x-[-0%] translate-y-[500%] max-[599px]:translate-y-[130%] font-bold px-16 py-3 max-[599px]:py-2 max-[599px]:px-10 border-2 border-white rounded-md hover:bg-white hover:text-[#003366] transition-all duration-300">
        Talk to us
    </button>
</section>
    ...
    <!-- Mobile Hero Section -->
    <section
        class="fade hero w-full h-[90vh] max-[599px]:flex hidden max-[599px]:h-[45vh] bg-contain max-[1025px]:bg-cover max-[1025px]:bg-center bg-no-repeat mt-24 max-[599px]:pt-32 items-end justify-center px-20 max-[1025px]:px-10 max-[599px]:px-4"
        style="background-image: url('{{ $data['banner_mobile'] }}');">
        <button class="text-white min-[2550px]:text-[2vw] max-[599px]:text-[2vw] -translate-y-2 font-bold px-16 py-3 max-[599px]:py-1 max-[599px]:px-8 border-2 border-white rounded-md hover:bg-white hover:text-[#003366] transition-all duration-300">
            Talk to us
          </button>  
    </section>
