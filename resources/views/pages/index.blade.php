    ...
    <section
        ...
        <div class="relative w-1/2 max-[599px]:w-full whitespace-nowrap max-[599px]:whitespace-normal">
            ...
            <div
                ...
                <h3 class="text-[3.5vw] max-[599px]:text-[9.5vw] font-[400] tracking-[0] font-[font1]">Weaving</h3>
                <h1
                    class="text-[6vw] max-[599px]:text-[18vw] font-[950] uppercase tracking-[1.04px] drop-shadow-lg leading-[6.67vw] max-[599px]:leading-tight text-[#FFD324] font-[font1]">
                    Digital Dreams</h1>
                <div class="w-full max-[599px]:w-[80%]">
                    <img class="object-cover" src="./assets/images/bannerSemiImage.webp" alt="">
                </div>
                <h4 class="text-[3.5vw] max-[599px]:text-[9.5vw] font-[400] tracking-[0] font-[font1]">or Innovate.
                    Amplify.
                    Convert.</h4>
                <button
