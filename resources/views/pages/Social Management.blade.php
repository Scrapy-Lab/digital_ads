  ...
  Talk to us
        ...
        <section class="fade flex flex-col lg:flex-row items-center justify-between py-12 max-[1025px]:py-6">
            ...
            <div class="relative w-[40%] max-[1025px]:w-full">
                <img src="./assets/images/Services/Social media/Social media Community Management/img 1.png" alt="Community Management Visual"
                    class="w-full max-[599px]:hidden h-auto rounded-md shadow-lg">
                <img src="./assets/images/Mobile Responsive/Social media Management/Img1.png" alt="Community Management Visual"
            ...
            <div class="w-[60%] max-[1025px]:w-full px-10 py-40 max-[1025px]:py-10 max-[1025px]:px-6 bg-white">
                <h2 class="text-xl lg:text-3xl font-bold mb-4 max-[599px]:mb-2">Why Social Media Community Management Matters
                </h2>
                <p class="mb-6 max-[599px]:mb-3 max-[599px]:text-[3.2vw] text-gray-700">
                A thriving online community strengthens brand loyalty, enhances customer relationships, and boosts engagement. Effective community management ensures that your brand stays connected with its audience, fostering trust and long-term relationships.
                </p>

                <ul class="space-y-4 text-gray-800 max-[599px]:text-[3.2vw]">
                    <li class="flex items-center gap-4">
                        <span class="bg-blue-600 inline-block w-4 h-4 rounded-full"></span>
                        <p><strong>What is social media community management?</strong></p>
                    </li>
                    <li class="flex items-center gap-4">
                        <span class="bg-blue-600 inline-block w-4 h-4 rounded-full"></span>
                        <p><strong>How does it improve brand reputation and engagement?</strong></p>
                    </li>
                    <li class="flex items-center gap-4">
                        <span class="bg-blue-600 inline-block w-4 h-4 rounded-full"></span>
                        <p><strong>Best practices for managing an online community effectively.</strong></p>
                    </li>
                </ul>
        ...
        <section class="fade flex flex-col lg:flex-row-reverse items-center justify-between ">
            ...
            <!-- Left Image Section -->
            <div class="relative w-[40%] max-[1025px]:w-full">
                <img src="./assets/images/Services/Social media/Social media Community Management/img2.png" alt="Community Management Visual"
                    class="w-full max-[599px]:hidden h-auto rounded-md shadow-lg">
                <img src="./assets/images/Mobile Responsive/Social media Management/img2.png" alt="Community Management Visual"
                    class="w-full max-[599px]:block hidden h-auto rounded-md shadow-lg">
            </div>

            <!-- Right Content Section -->
            <div class="w-[60%] max-[1025px]:w-full px-10 py-40 max-[1025px]:py-10 max-[1025px]:px-6 bg-white">
                <h2 class="text-xl lg:text-3xl font-bold mb-4 max-[599px]:mb-2">What is Social Media Community Management?
                </h2>
                <p class="mb-6 max-[599px]:mb-3 max-[599px]:text-[3.2vw] text-gray-700">
                Social Media Community Management is all about building and nurturing relationships with your audience. By engaging with followers, addressing concerns, and creating meaningful conversations, you can foster a loyal and active community around your brand.
                </p>

                <ul class="space-y-4 text-gray-800 max-[599px]:text-[3.2vw]">
                    <li class="flex items-center gap-4">
                        <span class="bg-blue-600 inline-block w-4 h-4 rounded-full"></span>
                        <p><strong>Real-Time Engagement:</strong> Respond to comments, messages, and mentions promptly.</p>
                    </li>
                    <li class="flex items-center gap-4">
                        <span class="bg-blue-600 inline-block w-4 h-4 rounded-full"></span>
                        <p><strong>Customer Relationship Building:</strong> Foster genuine interactions and create a sense of belonging.</p>
                    </li>
                    <li class="flex items-center gap-4">
                        <span class="bg-blue-600 inline-block w-4 h-4 rounded-full"></span>
                        <p><strong>Which platforms are best suited for your industry?Content Moderation:</strong> Ensure discussions stay positive and relevant to your brand.</p>
                    </li>
                </ul>
        ...
        <section class="fade w-full flex flex-col items-center max-[599px]:gap-4 relative mt-20 max-[1025px]:mt-10">
            <!-- Heading -->
            ...
            <div class="description w-[80%] max-[599px]:w-full">
                <p
                    ...
                    Our Approach to Elevate Your Brand’s Social Media Presence
                </p>
            </div>
            ...
            <div class="w-full h-full overflow-hidden -mt-36 max-[1025px]:-mt-20 max-[599px]:-mt-10 max-[599px]:hidden">
                <img class="w-full h-full object-cover object-center"
                    src="./assets/images/Globalimages/Work process.png" alt="What We Do" />
            </div>
            <div
                class="w-full h-full overflow-hidden hidden -mt-36 max-[1025px]:-mt-20 max-[599px]:-mt-10 max-[599px]:block">
                        ...
                        <div class="space-y-6 w-full">
                            ...
                            <div class="border-b border-white border-opacity-20 pb-4">
                                <button class="flex items-start gap-3 w-full text-left hover:no-underline faq-btn">
                                    ...
                                    <span class="flex-1 font-semibold">How do you measure social media Community Management
                                        success?</span>
                                    <span class="text-yellow-300 transition-transform duration-200 faq-icon">+</span>
                                </button>
                                <div class="ml-8 text-white text-opacity-80 mt-2 hidden faq-content">
