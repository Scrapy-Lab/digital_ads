...
@section('content')
    ...
    <section
        ...
        <button
            class="px-16 py-3 translate-x-[68%]  max-[1025px]:translate-x-14 translate-y-20 text-[1.5vw] max-[1025px]:text-[2vw] max-[599px]:text-[4vw] tracking-[0] mt-4 w-fit font-[600] text-[#F47815] bg-white border-2 border-[#F27A13]
    ...
    <section
        ...
        style="background-image: url('/assets/images/Services/Digital Marketing/Digital Marketing Strategy/Banner.png');">
        <button
            class="px-16 max-[599px]:px-8 max-[599px]:py-2 py-3 -ml-2 translate-y-12 text-[1.5vw] max-[1025px]:text-[2vw] max-[599px]:text-[3vw] tracking-[0] mt-4 w-fit font-[600] text-[#F47815] bg-white border-2 border-[#F27A13]
            shadow-[0px_4px_19px_2px_#FFC6996B] rounded-md
            hover:bg-[linear-gradient(92.21deg,_#F47A14_37.26%,_#FFC917_126.39%)] hover:text-white hover:border-transparent
            transition-all duration-300">
            Get in Touch
    ...
    <section class="fade flex flex-col lg:flex-row items-center justify-between py-12 max-[1025px]:py-6">
        ...
        <div class="relative w-[40%] max-[1025px]:w-full">
            <img src="/assets/images/Services/Digital Marketing/Digital Marketing Strategy/Img1.png"
    ...
    <section class="fade flex flex-col lg:flex-row-reverse items-center justify-between ">
        ...
        <!-- Left Image Section -->
        <div class="relative w-[40%] max-[1025px]:w-full">
            <img src="./assets/images/Services/Digital Marketing/Digital Marketing Strategy/img2.png"
                alt="Community Management Visual" class="w-full max-[599px]:hidden h-auto rounded-md shadow-lg">
            <img src="/assets/images/Services/Digital marketing/Digital marketing strategy/img2.png"
                alt="Community Management Visual" class="w-full max-[599px]:block hidden h-auto rounded-md shadow-lg">
        </div>
