...
<head>
    ...
    <title>Social Media Marketing - The Digital Add</title>
    <meta name="description"
        content="Expert social media marketing services to grow your business and engage your audience effectively." />
    <meta name="author" content="The Digital Add" />

    <meta property="og:title" content="Social Media Marketing - Saxxam Media" />
...
<body>
    <main class="bg-[#F3F5FE] overflow-hidden font-[font1]">
            ...
            <nav
                ...
                <div class="menu max-[599px]:hidden">
                    <ul class="flex gap-6 text-[1vw] max-[1025px]:text-sm text-[#001361] font-medium">
                        <li><a href="index.html" class="hover:text-orange-500 transition-all relative group">Home</a>
                        </li>

                        <li class="relative group">
                            <a class="hover:text-orange-500 transition-all cursor-pointer flex items-center gap-1">
                                Services <span>▼</span>
                            </a>
                            <div id="servicesMenu"
        ...
        <!-- Understanding Digital Marketing Strategy Section -->
        ...
        <footer
            ...
            <div class="right w-[75%] max-[1025px]:w-full h-full max-[1025px]:px-10">
                <div
                    class="links w-full h-full flex gap-28 max-[1025px]:gap-x-20 max-[1025px]:gap-y-6 max-[1025px]:flex-wrap pt-10 max-[1025px]:pt-6">
                    <div class="info">
                        <ul class="flex flex-col text-[1.2vw] max-[1025px]:text-[2.5vw] max-[599px]:text-[3.2vw]">
                            <li
                                class="font-bold text-[1.5vw] max-[1025px]:text-[3.0vw] max-[599px]:text-[3.5vw] mb-4 uppercase">
                                Info</li>
                            <li>Company</li>
                            <li>Products</li>
                            <li>Enginerring</li>
                ...
                <div
                    ...
                    <p class="text-[#00071B]/50 text-[1.5vw] max-[1025px]:text-[3.0vw] max-[599px]:text-[3.5vw]">© 2025
                        — Copyright</p>
                </div>
            </div>
            <div class="bg-img w-full h-full absolute bottom-0 left-0 z-[999] pointer-events-none">
                <img class="w-full h-full object-cover" src="./assets/images/Globalimages/Ellipse 2779.svg" alt="">
            </div>
        </footer>
        <!-- Footer Ends Here-->
