...
<head>
    ...
    <title>Website Maintanance - The Digital Add</title>
    <meta name="description"
        content="Expert Website Maintanance services to grow your business and engage your audience effectively." />
    <meta name="author" content="The Digital Add" />

    <meta property="og:title" content="Website Maintanance - Saxxam Media" />
...
<body>
    <main class="bg-[#F3F5FE] overflow-hidden font-[font1]">
        ...
        <section
            ...
            style="background-image: url('/assets/images/Services/Development/Website Maintanance/Banner.png');">
        ...
        <section class="flex flex-col lg:flex-row items-center justify-between py-12 max-[1025px]:py-6">
            ...
            <div class="relative w-[40%] max-[1025px]:w-full">
                <img src="/assets/images/Services/Development/Website Maintanance/img1.png" alt="Community Management Visual"
            ...
            <div class="w-[60%] max-[1025px]:w-full px-10 py-40 max-[1025px]:py-10 max-[1025px]:px-6 bg-white">
                <h2 class="text-xl lg:text-3xl font-bold mb-4 max-[599px]:mb-2">Website Maintanance for Businesses
                </h2>
                ...
                <ul class="space-y-4 text-gray-800 max-[599px]:text-[3.2vw]">
                    <li class="flex items-start">
                        ...
                        <p><strong>Why is Website Maintanance essential for your business?</strong></p>
                    </li>
                    <li class="flex items-start">
                        <span class="text-blue-600 mt-1 mr-2">•</span>
        ...
        <section class="flex flex-col lg:flex-row-reverse items-center justify-between ">
            ...
            <!-- Left Image Section -->
            <div class="relative w-[40%] max-[1025px]:w-full">
                <img src="./assets/images/Services/Development/Website Maintanance/img2.png" alt="Community Management Visual"
                    class="w-full max-[599px]:hidden h-auto rounded-md shadow-lg">
                <img src="/assets/images/Services/Development/Website Maintanance/img2.png" alt="Community Management Visual"
                    class="w-full max-[599px]:block hidden h-auto rounded-md shadow-lg">
            </div>
