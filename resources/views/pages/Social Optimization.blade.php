...
<head>
    ...
    <title>Social Media Optimization - The Digital Add</title>
    <meta name="description"
        content="Expert social media Optimization services to grow your business and engage your audience effectively." />
    <meta name="author" content="The Digital Add" />

    <meta property="og:title" content="Social Media Optimization - Saxxam Media" />
    ...
    @include('layouts.header')
        ...
        <section class="fade flex flex-col lg:flex-row items-center justify-between py-12 max-[1025px]:py-6">
            ...
            <div class="relative w-[40%] max-[1025px]:w-full">
                <img src="/assets/images/Services/Social media/Social media optimization/Frame 4558.png" alt="Optimization Visual"
                    class="w-full max-[599px]:hidden h-auto rounded-md shadow-lg">
                <img src="/assets/images/Mobile Responsive/Social media Optimization/Img 1.png" alt="Optimization Visual"
        ...
        <!-- Understanding Digital Optimization Strategy Section -->
                        ...
                        <div class="space-y-6 w-full">
                            ...
                            <div class="border-b border-white border-opacity-20 pb-4">
                                <button class="flex items-start gap-3 w-full text-left hover:no-underline faq-btn">
                                    ...
                                    <span class="flex-1 font-semibold">How do you measure social media Optimization
                                        success?</span>
                                    <span class="text-yellow-300 transition-transform duration-200 faq-icon">+</span>
                                </button>
                                <div class="ml-8 text-white text-opacity-80 mt-2 hidden faq-content">
